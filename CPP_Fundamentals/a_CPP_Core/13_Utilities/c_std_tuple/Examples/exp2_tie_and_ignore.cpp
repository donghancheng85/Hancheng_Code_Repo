...
int main(){
  ...
  // print the values. output: 1, 2, 3, 4
  ...
  // print the values. output: 1001, 1002, 1003, 4
  std::cout << "std::tuple tup2: (" << std::get<0>(tup2) << ", " << std::get<1>(tup2) << ", " << std::get<2>(tup2) << ", " << std::get<3>(tup2) << ")" << std::endl;
  std::cout << "global variables: " << first << " " << second << " " << third << " " << fourth << std::endl; // 1001, 1002, 1003, 1004
  ...
  // print the values. output: 1001, 1002, 1003, 1004
  ...
  // print the values
  std::cout << "a: " << a << std::endl; // 1002
  std::cout << "b: " << b << std::endl; // 1004
  ...
  // print the values
  std::cout << "a: " << a << std::endl; // 3001
  std::cout << "b: " << b << std::endl; // 3002
